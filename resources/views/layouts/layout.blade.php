...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'Admin Dashboard - Culture Bénin')</title>
    ...
    <aside class="app-sidebar slide-in-left">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-list">
                    <li class="nav-item">
                        <a href="{{ route('welcome') }}" class="nav-link @if(request()->routeIs('admin.dashboard')) active @endif">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-list">
                    <li class="nav-item">
                        <a href="{{ route('contenu.index') }}" class="nav-link @if(request()->routeIs('contenu.*')) active @endif">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-list">
                    <li class="nav-item">
                        <a href="{{ route('langue.index') }}" class="nav-link @if(request()->routeIs('langue.*')) active @endif">
                            <i class="nav-icon fas fa-language"></i>
                            <span class="nav-text">Langues</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('region.index') }}" class="nav-link @if(request()->routeIs('region.*')) active @endif">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-list">
                    <li class="nav-item">
                        <a href="{{ route('administrateur.index') }}" class="nav-link @if(request()->routeIs('administrateur.*')) active @endif">
                            <i class="nav-icon fas fa-crown"></i>
                            <span>Administrateurs</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('moderateur.index') }}" class="nav-link @if(request()->routeIs('moderateur.*')) active @endif">
                            <i class="nav-icon fas fa-user-shield"></i>
                            <span>Modérateurs</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('contributeur.index') }}" class="nav-link @if(request()->routeIs('contributeur.*')) active @endif">
                            <i class="nav-icon fas fa-user-edit"></i>
                            <span>Contributeurs</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('lecteur.index') }}" class="nav-link @if(request()->routeIs('lecteur.*')) active @endif">
        ...
        <div class="header-right">
            ...
            <div class="user-menu">
                <button class="user-btn">
                    <img src="{{ asset('assets/img/image_new_admin.img') }}" alt="Admin" class="user-avatar">
                ...
                <div class="user-dropdown">
                    ...
                    <a href="{{ route('help.index') }}" class="dropdown-item">
            ...
            <div class="app-content-header mb-4">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <h3 class="mb-0 fw-bold text-gradient-primary">@yield('page-title', 'Tableau de bord')</h3>
                            <p class="mb-0 text-muted">@yield('page-subtitle', 'Aperçu de vos performances')</p>
                        </div>
                        <div class="col-sm-6">
