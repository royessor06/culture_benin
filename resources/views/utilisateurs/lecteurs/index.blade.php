...
@section('title', 'Gestion des lecteurs')
@section('page-title', 'Lecteurs')
@section('page-subtitle', 'Gestion de tous les lecteurs')
    ...
    <div class="table-container card mb-4">
        <div class="table-header-actions d-flex justify-content-between align-items-center p-3">
            ...
            <div class="d-flex gap-2 align-items-center">
                {{-- Barre de recherche --}}
                <form action="{{ route('lecteur.index') }}" method="GET" class="me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('lecteur.show', $utilisateur->id) }}"
                                        class="table-btn table-btn-view"
                                        title="Voir">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <form action="{{ route('lecteur.destroy', $utilisateur->id) }}"
                                        method="POST"
                                        class="inline-form"
        ...
        <div class="table-pagination">
            <div class="pagination-info">
                Affichage de {{ $lecteurs->firstItem() }} à {{ $lecteurs->lastItem() }}
                sur {{ $lecteurs->total() }} résultats
            </div>
