...
<div class="card">
    ...
    <div class="card-footer">
        <a href="{{ route('contributeur.index') }}" class="btn btn-secondary">Retour</a>
        <form action="{{ route('contributeur.destroy', $utilisateur->id) }}" method="POST" style="display:inline;">
            @csrf
            @method('DELETE')
