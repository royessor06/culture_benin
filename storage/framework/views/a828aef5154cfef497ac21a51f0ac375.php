...
<div class="card mb-4">
    <div class="card-header">
        <h3 class="card-title">Modifier un modérateurs</h3>
    </div>
    <div class="card-body">
        <form action="<?php echo e(route('administrateur.update', $administrateur->id)); ?>" method="POST">
            ...
            <div class="mb-3">
                <label for="mot_de_passe" class="form-label">Email</label>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\culture\resources\views\utilisateurs\moderateurs\edit.blade.php ENDPATH**/ ?>