<?php $__env->startSection('title', 'Gestion des modérateurs'); ?>
<?php $__env->startSection('page-title', 'Modérateurs'); ?>
<?php $__env->startSection('page-subtitle', 'Gestion de tous les modérateurs'); ?>

<?php $__env->startSection('header-actions'); ?>
<div class="d-flex gap-2">
    <a href="<?php echo e(route('moderateur.create')); ?>" class="btn btn-primary btn-sm">
    ...
    <div class="table-container card mb-4">
        <div class="table-header-actions d-flex justify-content-between align-items-center p-3">
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <form action="<?php echo e(route('moderateur.index')); ?>" method="GET" class="me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="<?php echo e(route('moderateur.show', $utilisateur->id)); ?>"
                                        class="table-btn table-btn-view"
                                        title="Voir">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('moderateur.edit', $utilisateur->id)); ?>"
                                        class="table-btn table-btn-edit"
                                        title="Modifier">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="<?php echo e(route('moderateur.destroy', $utilisateur->id)); ?>"
                                        method="POST"
                                        class="inline-form"
        ...
        <div class="table-pagination">
            <div class="pagination-info">
                Affichage de <?php echo e($moderateurs->firstItem()); ?> à <?php echo e($moderateurs->lastItem()); ?>

                sur <?php echo e($moderateurs->total()); ?> résultats
            </div>
            <div class="pagination-links">
                <?php echo e($moderateurs->links()); ?>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\culture\resources\views/utilisateurs/moderateurs/index.blade.php ENDPATH**/ ?>