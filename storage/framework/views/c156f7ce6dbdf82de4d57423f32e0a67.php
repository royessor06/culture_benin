        ...
        * {
        ...
        .hero {
            ...
            background: linear-gradient(rgba(26, 26, 26, 0.7), rgba(26, 26, 26, 0.8)),
                        url('<?php echo e(asset("assets/img/hero-bg.jpg")); ?>') center/cover no-repeat;
            display: flex;
            align-items: center;
    ...
    <section id="categories" class="section">
        ...
        <div class="categories">
            ...
            <div class="category-card">
                <img src="<?php echo e(asset('assets/img/art.jpg')); ?>" alt="Art & Artisanat" class="category-img">
                <div class="category-content">
                    <h3>Art & Artisanat</h3>
                    <p>Découvrez l'artisanat traditionnel, les sculptures en bois, les textiles et les œuvres d'art contemporaines.</p>
                    <a href="<?php echo e(route('contenus.type', ['nom'=>'article'])); ?>" class="category-link">
            ...
            <!-- Histoire -->
            <div class="category-card">
                <img src="<?php echo e(asset('assets/img/histoire.jpg')); ?>" alt="Histoire" class="category-img">
                <div class="category-content">
                    <h3>Histoire & Traditions</h3>
                    <p>Retracez l'histoire fascinante du Bénin, des royaumes anciens aux traditions vivantes.</p>
                    <a href="<?php echo e(route('contenus.type', ['nom'=>'histoire'])); ?>" class="category-link">
                        Explorer <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <!-- Gastronomie -->
            <div class="category-card">
                <img src="<?php echo e(asset('assets/img/gastronomie.jpg')); ?>" alt="Gastronomie" class="category-img">
                <div class="category-content">
                    <h3>Gastronomie</h3>
                    <p>Savourez les délices culinaires béninois, des plats traditionnels aux recettes modernes.</p>
                    <a href="<?php echo e(route('contenus.type', ['nom'=>'recette'])); ?>" class="category-link">
                        Explorer <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <!-- Musique & Danse -->
            <div class="category-card">
                <img src="<?php echo e(asset('assets/img/danse.jpg')); ?>" alt="Musique & Danse" class="category-img">
                <div class="category-content">
                    <h3>Musique & Danse</h3>
                    <p>Explorez les rythmes entraînants et les danses traditionnelles qui célèbrent la vie.</p>
                    <a href="<?php echo e(route('contenus.type', ['nom'=>'musique'])); ?>" class="category-link">
                        Explorer <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
            </div>
                    ...
                    <div class="grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                        <div class="form-group">
                            ...
                            <select name="region_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($r->id); ?>"><?php echo e($r->nom); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="langue_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $langues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <div class="footer-links">
                <h4>Catégories</h4>
                <ul>
                    <li><a href="<?php echo e(route('contenus.type', ['nom'=>'article'])); ?>">Art & Artisanat</a></li>
                    <li><a href="<?php echo e(route('contenus.type', ['nom'=>'histoire'])); ?>">Histoire</a></li>
                    <li><a href="<?php echo e(route('contenus.type', ['nom'=>'recette'])); ?>">Gastronomie</a></li>
                    <li><a href="<?php echo e(route('contenus.type', ['nom'=>'musique'])); ?>">Musique & Danse</a></li>
                </ul>
            </div>
        </div>
