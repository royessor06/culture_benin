<?php $__env->startSection('title', 'Gestion des contributeurs'); ?>
<?php $__env->startSection('page-title', 'Contributeurs'); ?>
<?php $__env->startSection('page-subtitle', 'Gestion de tous les contributeurs'); ?>
    ...
    <div class="table-container card mb-4">
        <div class="table-header-actions d-flex justify-content-between align-items-center p-3">
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <form action="<?php echo e(route('contributeur.index')); ?>" method="GET" class="me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="<?php echo e(route('contributeur.show', $utilisateur->id)); ?>"
                                        class="table-btn table-btn-view"
                                        title="Voir">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <form action="<?php echo e(route('contributeur.destroy', $utilisateur->id)); ?>"
                                        method="POST"
                                        class="inline-form"
        ...
        <div class="table-pagination">
            <div class="pagination-info">
                Affichage de <?php echo e($contributeurs->firstItem()); ?> à <?php echo e($contributeurs->lastItem()); ?>

                sur <?php echo e($contributeurs->total()); ?> résultats
            </div>
            <div class="card-footer">
                <?php echo e($contributeurs->links()); ?>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\culture\resources\views\utilisateurs\contributeurs\index.blade.php ENDPATH**/ ?>