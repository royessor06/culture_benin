    ...
    <div class="register-container">
        <div class="register-card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('register.store')); ?>" @submit="isLoading = true" id="registerForm">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\culture\resources\views\register.blade.php ENDPATH**/ ?>