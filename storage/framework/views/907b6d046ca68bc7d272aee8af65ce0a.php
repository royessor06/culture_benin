...
<?php $__env->startSection('page-title', 'Administrateurs'); ?>
<?php $__env->startSection('page-subtitle', 'Gestion de tous les administrateurs'); ?>

<?php $__env->startSection('header-actions'); ?>
<div class="d-flex gap-2">
    <a href="<?php echo e(route('administrateur.create')); ?>" class="btn btn-primary btn-sm">
    ...
    <div class="table-container card mb-4">
        <div class="table-header-actions d-flex justify-content-between align-items-center p-3">
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <form action="<?php echo e(route('administrateur.index')); ?>" method="GET" class="me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="<?php echo e(route('administrateur.show', $utilisateur->id)); ?>"
                                        class="table-btn table-btn-view"
                                        title="Voir">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('administrateur.edit', $utilisateur->id)); ?>"
                                        class="table-btn table-btn-edit"
                                        title="Modifier">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="<?php echo e(route('administrateur.destroy', $utilisateur->id)); ?>"
                                        method="POST"
                                        class="inline-form"
        ...
        <div class="table-pagination">
            <div class="pagination-info">
                Affichage de <?php echo e($administrateurs->firstItem()); ?> à <?php echo e($administrateurs->lastItem()); ?>

                sur <?php echo e($administrateurs->total()); ?> résultats
            </div>
            <div class="card-footer">
                <?php echo e($administrateurs->links()); ?>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\culture\resources\views/utilisateurs/administrateurs/index.blade.php ENDPATH**/ ?>